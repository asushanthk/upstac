...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        // Get logged in tester
        User tester =userLoggedInService.getLoggedInUser();
        // Get all test requests assigned to the logged in tester
        List<TestRequest> testRequestsBelongingToUser = testRequestQueryService.findByTester(tester);
        // Return all results
        return testRequestsBelongingToUser;
    }
